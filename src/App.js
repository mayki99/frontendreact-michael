...
function App() {
  const baseUrl="http://localhost/API_ESTADIUM_JUGADOR/";
  ...
  const peticionPost=async()=>{
    ...
    f.append("num_camiseta", frameworkSeleccionado.num_camiseta);
    f.append("posicion", frameworkSeleccionado.posicion);
    ...
    .then(response=>{
      ...
      dataNueva.map(framework=>{
        if(framework.id===frameworkSeleccionado.id){
          ...
          framework.num_camiseta=frameworkSeleccionado.num_camiseta;
          framework.posicion=frameworkSeleccionado.posicion;          
        }
      });
      setData(dataNueva);
        ...
        <tbody>
          {data.map(framework=>(
            <tr key={framework.id}>
              ...
              <td>{framework.num_camiseta}</td>
              <td>{framework.posicion}</td>
              <td>
      ...
      <Modal isOpen={modalInsertar}>
        ...
        <ModalBody>
          <div className="form-group">
            ...
            <br />
            <label>num_camiseta: </label>
            <br />
            <input type="text" className="form-control" name="num_camiseta" onChange={handleChange}/>
            <br />
        ...
        <Modal isOpen={modalEditar}>
          ...
          <ModalBody>
            <div className="form-group">
              ...
              <label>num_camiseta: </label>
              <br />
              <input type="text" className="form-control" name="num_camiseta" onChange={handleChange} value={frameworkSeleccionado && frameworkSeleccionado.num_camiseta}/>
              <br />
              <label>posicion: </label>
              <br />
              <input type="text" className="form-control" name="posicion" onChange={handleChange} value={frameworkSeleccionado && frameworkSeleccionado.posicion}/>
              <br />
            </div>
          </ModalBody>
          <ModalFooter>
